        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {certifications.map((cert, index) => (
            <motion.div
              ...
              className="group relative bg-background border border-black/10 dark:border-white/10 rounded-2xl p-6 hover:border-secondary/50 transition-all duration-300 hover:shadow-lg"
            >
